...
static int vrstartx, vrfinishx, vrstarty, vrfinishy;
extern params data;
static int* candlistx, *candlisty;
static int *atlas;
static int anotherpass=0,maxcand = 40;
static F2D *target, *result;
static int *xloopout, *yloopout;
static int *xloopin, *yloopin;
